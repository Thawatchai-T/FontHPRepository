/*
 * File: app/view/main/mainmarketing/window/ComSpecialWindow.js
 *
...
Ext.define('FrontHPApp.view.main.mainmarketing.window.ComSpecialWindow', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.mainmainmarketingwindowcomspecialwindow',

    requires: [
        'FrontHPApp.view.main.mainmarketing.window.ComSpecialWindowViewModel',
        'FrontHPApp.view.main.mainmarketing.window.ComSpecialWindowViewController',
        'Ext.form.Panel',
        'Ext.form.FieldSet',
    ...
    controller: 'mainmainmarketingwindowcomspecialwindow',
    viewModel: {
        type: 'mainmainmarketingwindowcomspecialwindow'
    },
    autoShow: true,
    scrollable: true,
    layout: 'border',
